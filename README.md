...
- CUDA: Make sure CUDA and PyTorch versions are compatible if using GPU

### 4.2 Main dependencies

(Exact versions may vary; refer to your `requirements.txt` or `pip freeze` if available.)
...
> Note: On WSL, project paths look like `/home/username/projects/ForensicVision`,
